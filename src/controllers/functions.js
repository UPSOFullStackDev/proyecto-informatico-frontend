...
export const fetchClients = async (user_id) => {
  const clientsUrl = `http://10.220.161.230:5000/user/${user_id}/clients`;
...
export const fetchServices = async (user_id) => {
  const servicesUrl = `http://10.220.161.230:5000/user/${user_id}/services`;
  const requestOptions = getRequestOptions();
  try {
...
export const fetchProducts = async (user_id) => {
  const productsUrl = `http://10.220.161.230:5000/user/${user_id}/products`;
  const requestOptions = getRequestOptions();
  try {
...
export const addBill = (selectedClient, billItems, totalBill) => {
  ...
  fetch(`http://10.220.161.230:5000/user/${user_id}/sales`, addBillRequestOptions)
    .then((response) => {
