const url = "http://10.220.161.230:5000/user/";
const user_id = localStorage.getItem("id");
const getBillsUrl = `http://10.220.161.230:5000/user/${user_id}/sales`;
const getClientsUrl = `http://10.220.161.230:5000/user/${user_id}/clients`;
const getProductsUrl = `http://10.220.161.230:5000/user/${user_id}/products`;
const getServicesUrl = `http://10.220.161.230:5000/user/${user_id}/services`;
