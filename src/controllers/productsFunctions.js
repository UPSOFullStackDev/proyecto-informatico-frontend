...
export const saveProduct = async (user_id, product) => {
  const url = product.id
    ? `http://10.220.161.230:5000/user/${user_id}/products/${product.id}`
    : `http://10.220.161.230:5000/user/${user_id}/products`;
...
export const deleteProduct = async (user_id, productId) => {
  const url = `http://10.220.161.230:5000/user/${user_id}/products/${productId}`;
